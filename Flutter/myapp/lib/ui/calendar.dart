...
class Calendar extends StatefulWidget {
  ...
  const Calendar({required this.listController});

  @override
  _CalendarState createState() =>
      _CalendarState(listController: listController);
}

class _CalendarState extends State<Calendar> {
  final ScrollController listController;

  _CalendarState({required this.listController});
  ...
  void _onDaySelected(DateTime day, DateTime day2) {
    setState(() {
      ...
      listController.animateTo(index * 160,
  ...
  void _fetchEvents() async {
    ...
    List<Map<String, dynamic>> _results =
        []; //await DB.query(CalendarItem.table);
  ...
  void _addEvent(String event) async {
    CalendarItem item =
        CalendarItem(id: 1, date: _selectedDay.toString(), name: event);
