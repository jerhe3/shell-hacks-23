...
class SuggestionsPageState extends State<SuggestionsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    slivers: <Widget>[
      SliverAppBar(
        title: Text('Suggestions', style: TextStyle(color: Color.fromRGBO(0, 0, 0, _titleOpacity),fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Container( height: 50,
              child: Column(
                ...
                children: [
                  Row(children: [Text("Welcome to",style: TextStyle(color: Color.fromRGBO(255,255,255,_welcomeOpacity), fontSize: 20.0, fontWeight: FontWeight.w700,)), Text(" Miami!",style: TextStyle(color:Color.fromRGBO(255,255,255,_welcomeOpacity), fontSize: 20.0, fontWeight: FontWeight.w900),)]),
                  Text("Get an AI-curated list of suggested activities to do during your personal free times.",style: TextStyle(color: Color.fromRGBO(255,255,255,_welcomeOpacity), fontSize: 9.0),)
                ]
              ),
            ),
          )
  ...
  floatingActionButton: FloatingActionButton(onPressed: () => _promptAI(context),
  child: ImageIcon(AssetImage('assets/wand.png'),size: 30.0,)),
  );
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Generate Ideas", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
...
class SuggestionsRowState extends State<SuggestionsRow> with AutomaticKeepAliveClientMixin {
            ...
            children: [
              Padding(
                ...
                child: Align(alignment: Alignment.centerLeft,
                  child: Text(prompt,style:TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold)),
                ),
              ),
              Container(
                height: 300,
  ...
  DateTimeRange _randomRange() {
    return CalendarSuggestions.prunedFreeTimes[rand.nextInt(CalendarSuggestions.prunedFreeTimes.length)];
